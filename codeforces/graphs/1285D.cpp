...
// If at a bit pos, all bits are same, then we can turn it off(all 0s or all 1s)
// so in answer that would be 0. If any of the group is not empty this bit differs 
// and would have to be turned on.
