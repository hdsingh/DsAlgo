...
int main(){
    Solution sol; int n; vvi edges; int out, distanceThreshold; 
    n = 4, edges = {{0,1,3},{1,2,1},{1,3,4},{2,3,1}}, distanceThreshold = 4;
    out = sol.findTheCity(n,edges,distanceThreshold); deb(out);
